...
MacOSConfig _$MacOSConfigFromJson(Map json) =>
    $checkedCreate('MacOSConfig', json, ($checkedConvert) {
      final val = MacOSConfig(
        ...
        darkImagePath:
            $checkedConvert('dark_image_path', (v) => v as String?),
        tintedImagePath:
            $checkedConvert('tinted_image_path', (v) => v as String?),
