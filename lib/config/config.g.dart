...
Map<String, dynamic> _$ConfigToJson(Config instance) => <String, dynamic>{
  ...
  'hasAndroidAdaptiveConfig': instance.hasAndroidAdaptiveConfig,
  'hasAndroidAdaptiveMonochromeConfig':
      instance.hasAndroidAdaptiveMonochromeConfig,
  'hasPlatformConfig': instance.hasPlatformConfig,
  'hasWebConfig': instance.hasWebConfig,
  'hasWindowsConfig': instance.hasWindowsConfig,
  'hasMacOSConfig': instance.hasMacOSConfig,
  'isCustomAndroidFile': instance.isCustomAndroidFile,
