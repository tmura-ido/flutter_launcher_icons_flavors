...
void main() {
  group('issue #535: transparent adaptive_icon_background is preserved in colors.xml',
      () {
    test('updateColorsFile writes the literal hex with alpha preserved',
        () async {
    ...
    test('updating an existing color entry preserves the new alpha', () async {
